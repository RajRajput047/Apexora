"""
Django settings for Apexora project - Production Ready for Render
"""
import os
...
# Database Configuration - Use Neon PostgreSQL on Render
DATABASE_URL = os.getenv('DATABASE_URL')

if DATABASE_URL:
    # For Render/Neon PostgreSQL
    DATABASES = {
...
if not DEBUG:
    CORS_ALLOWED_ORIGINS.append('https://apexora-n1h0.onrender.com')  # Add your domain
